    ...
    return (
      <div>
        ...
        <ul className="hoglist">
          <BabyHog name={offspring[0].name} eyeColor={this.state.eyeColor} hobby={offspring[0].name}/>
          <BabyHog name={offspring[1].name} eyeColor={this.state.eyeColor} hobby={offspring[1].name}/>
          <BabyHog name={offspring[2].name} eyeColor={this.state.eyeColor} hobby={offspring[2].name}/>
