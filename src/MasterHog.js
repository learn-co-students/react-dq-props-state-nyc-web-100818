    ...
    return (
      <div>
        ...
        <ul className="hoglist">
          <BabyHog
            eyeColor={this.state.eyeColor} hobby={offspring[0].hobby}
            name={offspring[0].name} />
            <BabyHog
              eyeColor={this.state.eyeColor} hobby={offspring[1].hobby}
              name={offspring[1].name} />
            <BabyHog
              eyeColor={this.state.eyeColor} hobby={offspring[2].hobby}
